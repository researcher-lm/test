view: compliance_user_permissions {
  sql_table_name: `23edeced7d75ee`.compliance_user_permissions ;;
  drill_fields: [id]
  ...
  dimension: gemini_in_looker {
    type: number
    sql: ${TABLE}.gemini_in_looker ;;
  }
  ...
  dimension: manage_modelsets_restricted {
    type: number
    sql: ${TABLE}.manage_modelsets_restricted ;;
  }
