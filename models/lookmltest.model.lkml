...
datagroup: lookmltest_default_datagroup {
  # sql_trigger: SELECT MAX(id) FROM etl_log;;
  max_cache_age: "1 hour"
}

persist_with: lookmltest_default_datagroup
...
explore: access_token {
  ...
  join: group {
    type: left_outer
    sql_on: ${oauth_client_app.group_id} = ${group.id} ;;
    relationship: many_to_one
  }
...
explore: action_hub_secret_user_state {
  join: user {
    type: left_outer
    sql_on: ${action_hub_secret_user_state.user_id} = ${user.id} ;;
    relationship: many_to_one
  }
...
explore: action_hub_state_authentication {
  join: user {
    type: left_outer
    sql_on: ${action_hub_state_authentication.user_id} = ${user.id} ;;
    relationship: many_to_one
  }
...
explore: active_pdt_materialize_task {
  ...
  join: user {
    type: left_outer
    sql_on: ${active_pdt_materialize_task.user_id} = ${user.id} ;;
    relationship: many_to_one
  }
...
explore: alert_destination {
  ...
  join: user {
    type: left_outer
    sql_on: ${alert_destination.user_id} = ${user.id} ;;
    relationship: many_to_one
  }
...
explore: alert_notification {
  ...
  join: user {
    type: left_outer
    sql_on: ${alert_notification.user_id} = ${user.id} ;;
    relationship: many_to_one
  }
...
explore: content_digest_item {
  ...
  join: user {
    type: left_outer
    sql_on: ${user_content_digest.user_id} = ${user.id} ;;
    relationship: many_to_one
  }
...
explore: email_verification {
  join: user {
    type: left_outer
    sql_on: ${email_verification.user_id} = ${user.id} ;;
    relationship: many_to_one
  }
...
explore: google_config {}

explore: google_config_default_new_user_role {
  join: google_config {
    type: left_outer
    sql_on: ${google_config_default_new_user_role.google_config_id} = ${google_config.id} ;;
    relationship: many_to_one
  }

  join: role {
    type: left_outer
    sql_on: ${google_config_default_new_user_role.role_id} = ${role.id} ;;
    relationship: many_to_one
  }
...
explore: google_group {
  join: google_config {
    type: left_outer
    sql_on: ${google_group.google_config_id} = ${google_config.id} ;;
    relationship: many_to_one
  }

  join: group {
    type: left_outer
    sql_on: ${google_group.group_id} = ${group.id} ;;
    relationship: many_to_one
  }

  join: proposed_group {
    type: left_outer
    sql_on: ${google_group.proposed_group_id} = ${proposed_group.id} ;;
    relationship: many_to_one
  }
}

explore: google_group_info_delete_sync_tasks {
  join: google_group {
    type: left_outer
    sql_on: ${google_group_info_delete_sync_tasks.google_group_id} = ${google_group.id} ;;
    relationship: many_to_one
  }
...
explore: google_group_mappings {
  join: google_group {
    type: left_outer
    sql_on: ${google_group_mappings.google_group_id} = ${google_group.id} ;;
    relationship: many_to_one
  }
...
explore: google_group_sync_tasks {}

explore: google_groups_sync_status {
  join: user {
    type: left_outer
    sql_on: ${google_groups_sync_status.user_id} = ${user.id} ;;
    relationship: many_to_one
  }
...
explore: homepage {
  ...
  join: user {
    type: left_outer
    sql_on: ${homepage.user_id} = ${user.id} ;;
    relationship: many_to_one
  }
...
explore: homepage_event {
  ...
  join: user {
    type: left_outer
    sql_on: ${homepage_event.user_id} = ${user.id} ;;
    relationship: many_to_one
  }
...
explore: login_attempt {
  join: user {
    type: left_outer
    sql_on: ${login_attempt.user_id} = ${user.id} ;;
    relationship: many_to_one
  }
...
explore: marketplace_install_task {
  join: user {
    type: left_outer
    sql_on: ${marketplace_install_task.user_id} = ${user.id} ;;
    relationship: many_to_one
  }
...
explore: materialized_visible_content {
  join: content_metadata {
    type: left_outer
    sql_on: ${materialized_visible_content.content_metadata_id} = ${content_metadata.id} ;;
    relationship: many_to_one
  }

  join: user {
    type: left_outer
    sql_on: ${materialized_visible_content.user_id} = ${user.id} ;;
    relationship: many_to_one
  }
...
explore: mobile_token {
  join: user {
    type: left_outer
    sql_on: ${mobile_token.user_id} = ${user.id} ;;
    relationship: many_to_one
  }
...
explore: oauth_client_app_user_activation {
  ...
  join: user {
    type: left_outer
    sql_on: ${oauth_client_app_user_activation.user_id} = ${user.id} ;;
    relationship: many_to_one
  }
...
explore: oauth_request_state {
  ...
  join: user {
    type: left_outer
    sql_on: ${oauth_user_state.user_id} = ${user.id} ;;
    relationship: many_to_one
  }
...
explore: pending_job_state {
  ...
  join: user {
    type: left_outer
    sql_on: ${pending_job_state.user_id} = ${user.id} ;;
    relationship: many_to_one
  }
...
explore: project_dependency {}

explore: project_deployment {
  join: user {
    type: left_outer
    sql_on: ${project_deployment.user_id} = ${user.id} ;;
    relationship: many_to_one
  }
...
explore: project_log {
  join: user {
    type: left_outer
    sql_on: ${project_log.user_id} = ${user.id} ;;
    relationship: many_to_one
  }
...
explore: proxy_nonce {
  join: user {
    type: left_outer
    sql_on: ${proxy_nonce.user_id} = ${user.id} ;;
    relationship: many_to_one
  }
...
explore: query_task {
  ...
  join: user {
    type: left_outer
    sql_on: ${query_task.user_id} = ${user.id} ;;
    relationship: many_to_one
  }
...
explore: report_favorite {
  join: report {
    type: left_outer
    sql_on: ${report_favorite.report_id} = ${report.id} ;;
    relationship: many_to_one
  }

  join: user {
    type: left_outer
    sql_on: ${report_favorite.user_id} = ${user.id} ;;
    relationship: many_to_one
  }
...
explore: report_user_usage {
  join: report {
    type: left_outer
    sql_on: ${report_user_usage.report_id} = ${report.id} ;;
    relationship: many_to_one
  }

  join: user {
    type: left_outer
    sql_on: ${report_user_usage.user_id} = ${user.id} ;;
    relationship: many_to_one
  }
...
explore: slack_identity {
  join: user {
    type: left_outer
    sql_on: ${slack_identity.user_id} = ${user.id} ;;
    relationship: many_to_one
  }
...
explore: studio_folder_sync_job {}

explore: studio_sync_operation {}
...
explore: user_facts {
  join: user {
    type: left_outer
    sql_on: ${user_facts.user_id} = ${user.id} ;;
    relationship: many_to_one
  }
...
explore: user_facts_role {
  ...
  join: user {
    type: left_outer
    sql_on: ${user_facts_role.user_id} = ${user.id} ;;
    relationship: many_to_one
  }
...
explore: user_ide_project_state {
  join: user {
    type: left_outer
    sql_on: ${user_ide_project_state.user_id} = ${user.id} ;;
    relationship: many_to_one
  }
...
explore: user_ide_state {
  join: user {
    type: left_outer
    sql_on: ${user_ide_state.user_id} = ${user.id} ;;
    relationship: many_to_one
  }
